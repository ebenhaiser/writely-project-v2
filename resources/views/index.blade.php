...
<head>
  ...
  <!-- [Favicon] icon -->
  <link rel="icon" href="{{ asset('src/assets/images/favicon.svg') }}" type="image/x-icon" />
  <!-- [Google Font] Family -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" id="main-font-link" />
  <!-- [phosphor Icons] https://phosphoricons.com/ -->
  <link rel="stylesheet" href="{{ asset('src/assets/fonts/phosphor/duotone/style.css') }}" />
  <!-- [Tabler Icons] https://tablericons.com -->
  <link rel="stylesheet" href="{{ asset('src/assets/fonts/tabler-icons.min.css') }}" />
  <!-- [Feather Icons] https://feathericons.com -->
  <link rel="stylesheet" href="{{ asset('src/assets/fonts/feather.css') }}" />
  <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
  <link rel="stylesheet" href="{{ asset('src/assets/fonts/fontawesome.css') }}" />
  <!-- [Material Icons] https://fonts.google.com/icons -->
  <link rel="stylesheet" href="{{ asset('src/assets/fonts/material.css') }}" />
  <!-- [Template CSS Files] -->
...
<body>
  ...
  <!-- Required Js -->
  <script src="{{ asset('src/assets/js/plugins/popper.min.js') }}"></script>
  <script src="{{ asset('src/assets/js/plugins/simplebar.min.js') }}"></script>
  <script src="{{ asset('src/assets/js/plugins/bootstrap.min.js') }}"></script>
  {{-- <script src="{{ asset('src/assets/js/icon/custom-font.js') }}"></script> --}}
  ...
  <!-- Apex Chart -->
  <script src="{{ asset('src/assets/js/plugins/apexcharts.min.js') }}"></script>
  <script src="{{ asset('src/assets/js/pages/dashboard-default.js') }}"></script>
