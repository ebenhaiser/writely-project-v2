        ...
        <div class="align-items-center row">
            ...
            <div class="bg-white rounded-bottom smooth-shadow-sm ">
                <div class="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar-profile avatar-xxl avatar-indicators avatar-online me-2 position-relative d-flex justify-content-end align-items-end mt-n10">
            ...
            <div class="mt-3 mb-3 px-4 d-flex gap-5 profile-post-follow">
                ...
                <span>
                    ...
                    <h6>Followers</h6>
                    <p align="center" class="follower-count">30</p>
                </a>
            </span>
        </div>
